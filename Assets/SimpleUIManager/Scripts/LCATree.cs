...
namespace SUIM
{
    ...
    {
        public static LCATree Build(ViewsManager viewsManager)
        {
            var lcaTree = new LCATree();
            var availableViews = Helpers.FindAllComponentsInChildrenHierarchy<ViewBase>(viewsManager.gameObject);
            ...
            lcaTree.BuildLCATable(viewsManager.GetComponent<RootView>(), availableViews);
